...
The individual sensors collect the data and send it over 2.4ghz packet radio over a tree network to the main hub. The main hub receives the data amd stores it in an sd card.
